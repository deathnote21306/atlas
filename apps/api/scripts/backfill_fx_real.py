...
def main() -> None:
    ...
    with SessionLocal() as s:
        ...
        deleted = s.execute(delete(FxRate).where(FxRate.source == "seed_approximation")).rowcount
        ...
        source_counts = s.execute(select(FxRate.source, func.count()).group_by(FxRate.source)).all()
        print("\nSource breakdown:")
